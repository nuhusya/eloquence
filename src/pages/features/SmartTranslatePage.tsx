...
import { Languages, Loader2, SendHorizonal, FileDown, Copy, Check } from 'lucide-react';
...
[casual translation]`;
  ...
  const handleExport = () => {
    if (result) {
      exportToPDF('result-content', `translate-${Date.now()}`);
    }
  };
                ...
                {result.split('###').map((part, i) => {
                  ...
                  return (
                    <div key={i}>
                       ...
                       <div className="bg-cream/40 p-4 rounded-xl border-l-4 border-maroon/20 markdown-body font-sans">
